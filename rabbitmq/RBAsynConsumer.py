...
class RBAsynConsumer(object):
    ...
    #     self._url = amqp_url
    #
    # def __init__(self, amqp_url, routing_key=None):
    #     self._connection = None
    #     self._channel = None
    #     self._closing = False
    #     self._consumer_tag = None
    ...
    #
    # def __init__(self, amqp_url, exchange=None, exchange_type=None, queue_name=None, routing_key=None):
    #     self._connection = None
    #     self._channel = None
    #     self._closing = False
    #     self._consumer_tag = None
    ...
    def __init__(self, amqp_url, routing_key=None, exchange_type=None):
        self._connection = None
        self._channel = None
        self._closing = False
        self._consumer_tag = None
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(self.on_exchange_declareok, exchange=exchange_name, exchange_type=self.EXCHANGE_TYPE,
                                       durable=True)
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(self.on_queue_declareok, queue=queue_name, durable=True, exclusive=False, auto_delete=False)
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        try:
            ...
            logging.error("RBAsynConsumer.processMessage: ", e)
    ...
    def process_message(self, basic_deliver, properties, body):
        ...
        logger.info('---------- RBAsynConsumer process message ----------')
    ...
    def run(self):
        ...
        """
        self._connection = self.connect()
        logging.info("+++++ Instance rbAsynConsumer[%s] running... +++++", self.ROUTING_KEY)
        self._connection.ioloop.start()
...
def main():
    ...
    rbconsumer = RBAsynConsumer('amqp://admintest:admintest123@localhost:5672/%2F')
    try:
        rbconsumer.run()
        logging.info("Instance RBAsynConsumer[%s] running...", rbconsumer.ROUTING_KEY)
