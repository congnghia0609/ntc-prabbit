...
class RBAsynPublisher(object):
    ...
    def __init__(self, amqp_url, routing_key=None, interval=1.0):
        self._connection = None
        self._channel = None
        self._deliveries = []
        self._acked = 0
    ...
    # def __init__(self, amqp_url, exchange=None, exchange_type=None, queue_name=None, routing_key=None, interval=1.0):
    #     self._connection = None
    #     self._channel = None
    #     self._deliveries = []
    #     self._acked = 0
    ...
    #     if(exchange_type): self.EXCHANGE_TYPE = exchange_type
    #     if(queue_name): self.QUEUE = queue_name
    #     if(routing_key): self.ROUTING_KEY = routing_key
    #     if(interval > 0.0): self.PUBLISH_INTERVAL = interval
    ...
    def publish_message(self):
        ...
        message = {u'111': u'aaa',
                   u'222': u'bbb',
                   u'333': u'ccc',
                   u'numMsg': self._message_number}
        properties = pika.BasicProperties(app_id='rbAsynPublisher',
