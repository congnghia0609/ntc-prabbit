...
class RBAsynTConsumer(object):
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(self.on_exchange_declareok, exchange=exchange_name,
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        try:
            ...
            logging.error("RBAsynTConsumer.processMessage: ", e)
    ...
    def process_message(self, basic_deliver, properties, body):
        ...
        logger.info('---------- RBAsynTConsumer process message ----------')
    ...
    def run(self):
        ...
        """
        self._connection = self.connect()
        logging.info("+++++ Instance RBAsynTConsumer[%s] running... +++++", self.ROUTING_KEY)
...
def main():
    ...
    rbconsumer = RBAsynTConsumer('amqp://admintest:admintest123@localhost:5672/%2F')
    try:
        rbconsumer.run()
        logging.info("Instance RBAsynTConsumer[%s] running...", rbconsumer.ROUTING_KEY)
